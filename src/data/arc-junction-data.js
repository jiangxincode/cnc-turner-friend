...
export const qtPages = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { id: 'angleLen', label: '角度长', type: 'number', default: 0.6 },
      { id: 'arcLen',   label: '圆弧长', type: 'number', default: '' },
  ...
  },
  {
    ...
    layout: 'two-col',
    inputs: [
      { id: 'large', label: '直径',   type: 'number', default: 8 },
  ...
  },
  {
    ...
    inputs: [
      ...
      { id: 'D',           label: 'D',        type: 'number', default: '' },
      { id: 'rr',          label: 'r',        type: 'number', default: 5 },
      { id: 'R',           label: 'R',        type: 'number', default: 25 },
      { id: 'actualSmall', label: '实际小径', type: 'number', default: '' },
      { id: 'zStart',      label: 'z起点',    type: 'number', default: 0 },
      { id: 'tip',         label: '刀尖补偿', type: 'optional', default: 0.4 },
      { id: 'juedui',      label: '坐标系',   type: 'radio', default: 'true', options: coordTypeOptions },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { id: 'r',     label: '小R',    type: 'number', default: 3 },
      { id: 'tip',   label: '刀尖补偿', type: 'optional', default: 0.4 },
      { id: 'juedui', label: '坐标系', type: 'radio', default: 'true', options: coordTypeOptions },
    ],
  },
  ...
  },
  {
    id: 'qt10',
    title: '球头接点10',
    diagram: 'static/yhjd/yh52.png',
    tip: '尽量填写已知尺寸',
    inputs: [
      { id: 'large', label: '大径',   type: 'number', default: '' },
      { id: 'd1',    label: '直径1',  type: 'number', default: 26 },
      { id: 'd2',    label: '直径2',  type: 'number', default: '' },
      { id: 'small', label: '直径3',  type: 'number', default: 68 },
      { id: 'long1', label: '长度1',  type: 'number', default: '' },
      { id: 'long2', label: '长度2',  type: 'number', default: '' },
